...
export default async function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-green-950">
      <div className="bg-white rounded-2xl shadow-xl p-10 flex flex-col items-center gap-6 w-full max-w-sm">
        <div className="text-center">
          <p className="text-4xl mb-2">⚽</p>
          <h1 className="text-2xl font-bold text-gray-900">Porra Mundial 2026</h1>
          <p className="text-sm text-gray-500 mt-1">Entra para hacer tus pronósticos</p>
        </div>
