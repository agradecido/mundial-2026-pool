                ...
                {(role === "ADMIN" || role === "EDITOR") && (
                    <div className="pt-1 border-t border-white/10">
                        <Link
                            ...
                            onClick={close}
                            className="flex items-center justify-center gap-2 w-full rounded-lg px-4 py-2 text-sm text-gray-500 hover:text-gray-300 hover:bg-white/5 transition-colors"
                        >
